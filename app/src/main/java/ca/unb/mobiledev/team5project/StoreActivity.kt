    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ship.setOnClickListener {
            ...
            try {
                ...
                bundle.putString("decoType", decoList.get(10).decoType)
                bundle.putString("placement", decoList.get(10).placement)
                bundle.putInt("food", statistics.Fishfood)
                intent.putExtras(bundle)
                startActivity(intent)
            } catch (ex: ActivityNotFoundException) {
        ...
        kraken.setOnClickListener {
            ...
            try {
                ...
                bundle.putString("cost", decoList.get(11).cost)
                bundle.putString("decoType", decoList.get(11).decoType)
                bundle.putString("placement", decoList.get(11).placement)
                bundle.putInt("food", statistics.Fishfood)
                intent.putExtras(bundle)
                startActivity(intent)
            } catch (ex: ActivityNotFoundException) {
